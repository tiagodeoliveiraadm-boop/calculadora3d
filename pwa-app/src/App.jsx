...
const db = {
  get(key)        { try { const v = localStorage.getItem(key); return Promise.resolve(v ? JSON.parse(v) : null); } catch { return Promise.resolve(null); } },
  set(key, val)   { try { localStorage.setItem(key, JSON.stringify(val)); } catch {} return Promise.resolve(); },
